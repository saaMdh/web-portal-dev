...
import Queries from "@/components/SiteBuilder/Blocks/Store/AnnounCarousel/AnnouncementCarouselQuery.graphql";
...
export default {
  ...
  computed: {
    ...mapGetters({ store: "builder/store", phoneMode: "builder/phoneMode" }),
    query() {
